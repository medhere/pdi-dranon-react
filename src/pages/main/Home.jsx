...
import { initTiledesk } from "../../libs/tiledesk";
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    // window?.tiledesk?.on('onInit', function(){
    //   console.log('loaded')
    //   setLoadchat(true)
    // })
  }, []);
  ...
  return (
    <>
      <section className="w-[100%] md:w-[100%] xl:w-[40%] lg:w-[60%] px-4 mt-7">
        ...
        {/* AD */}
        <div className="bg-white rounded-lg shadow-lg mt-6 py-8">
          <img
        ...
        <div className="bg-orange-100 ">
          <div className="lg:flex lg:items-center lg:justify-between w-full mx-auto py-6 my-10 px-4 sm:px-2 lg:py-16 lg:px-8">
            <h2 className="text-2xl font-extrabold text-black  sm:text-4xl">
              <span className="block">What bothers you today?</span>
        ...
        (
          <section>
            <div className="flex justify-between items-center mt-10 shadow-md bg-slate-50 p-5 rounded-sm">
              <h1 className="font-bold text-xl md:text-2xl text-blue-950 text-center">
